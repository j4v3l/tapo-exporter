...
class TapoExporter:
    def __init__(self, devices: Optional[List[P110Device]] = None):
        ...
        for device in self.devices:
            ...
            try:
                ...
                if voltage == 0:
                    ...
                    voltage = (
                        STANDARD_VOLTAGE_240V if power > 1800 else STANDARD_VOLTAGE_120V
                    )
                    logger.info(
                ...
                overcurrent_protection = bool(
                    getattr(usage_info, "overcurrent_protection", False)
                )
                overheat_protection = bool(
                    getattr(usage_info, "overheat_protection", False)
                )
                ...
                try:
                    ...
                    point = (
                        ...
                        .field(
                            ...
                            self.accumulated_energy[device_name],
                        )
    ...
    async def start(self, port: int = 0) -> None:
        ...
        try:
            ...
            logger.info(
                ...
                if port != 0
                else "Started Prometheus HTTP server on OS-assigned port"
            )
        except OSError as e:
            if e.errno == 48:  # Address already in use
                ...
                try:
                    ...
                    logger.error(f"Failed to start Prometheus server: {str(exc)}")
