...
def main():
    ...
    try:
        ...
        handshake_data = {
            "method": "handshake",
            "params": {"protocol": "KLAP", "key": klap_key, "deviceId": device_id},
        }
        ...
        response = requests.post(
            f"http://{host}/app",
            json=handshake_data,
            headers={"Content-Type": "application/json", "User-Agent": "Tapo/2.8.21"},
            timeout=5,
        )
        ...
        # Get device info
        device_info_data = {"method": "get_device_info", "params": {}}
